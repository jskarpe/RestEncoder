...
class Job implements JobInterface
{
	 ...
	 * @var MediaFile
	 *
	 * @ORM\OneToOne(targetEntity="MediaFile")
	 */
	 ...
	 * @var array
	 *
	 * @ORM\OneToMany(targetEntity="Thumbnail", mappedBy="job")
	 */
	private $thumbnails;
	 ...
	 * @var string
	 *
	 * @ORM\Column(name="input", type="string", length=2048)
	 */
	private $input;
	 ...
	 * @var boolean
	 *
	 * @ORM\Column(name="live_stream", type="boolean")
	 */
	 ...
	 * @var integer
	 *
	 * @ORM\Column(name="download_connections", type="smallint")
	 */
	 ...
	 * @var string
	 *
	 * @ORM\Column(name="pass_through", type="string", nullable=true)
	 */
	private $passThrough;
	 ...
	 * @var boolean
	 *
	 * @ORM\Column(name="mock", type="boolean")
	 */
	private $mock = false;
	 ...
	 * @var string
	 *
	 * @ORM\Column(name="grouping", type="string", nullable=true)
	 */
	private $grouping;
	 ...
	 * @var string
	 *
	 * @ORM\Column(name="aspera_transfer_policy", type="string")
	 */
	 ...
	 * @var integer
	 *
	 * @ORM\Column(name="transfer_minimum_rate", type="integer")
	 */
	 ...
	 * @var integer
	 *
	 * @ORM\Column(name="transfer_maximum_rate", type="integer")
	 */
	 ...
	 * @var string
	 *
	 * @ORM\Column(name="expected_md5_checksum", type="string", nullable=true)
	 */
	 ...
	 * @var string
	 *
	 * @ORM\Column(name="credentials", type="string", nullable=true)
	 */
	private $credentials;
