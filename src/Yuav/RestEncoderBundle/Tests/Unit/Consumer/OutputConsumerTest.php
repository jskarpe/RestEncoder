...
class OutputConsumerTest extends WebTestCase
{
    ...
    public function setUp()
    {
        ...
        $this->em = static::$kernel->getContainer()
            ->get('doctrine')
            ->getManager();
        $this->filesystemMap = static::$kernel->getContainer()->get('knp_gaufrette.filesystem_map');
    ...
    public function testProcessOutputQueueItem()
    {
        ...
        $consumer = new OutputConsumer($entityManager, FFMpeg::create(), $this->filesystemMap);
        
        $queueMsg = new AMQPMessage();
        $queueMsg->body = json_encode(array(
